...
class Supervisor
{
     ...
     * @param string|null $username Default set to null
     * @param string|null $password Default set to null
     * @param integer|null $port Default set to null
     */
    public function __construct(string $name, string $ipAddress, ?string $username = null, ?string $password = null, ?int $port = null)
    {
        $this->name = $name;
     ...
     * @param null $password
     */
    private function createKey(string $ipAddress, $port, $username = null, $password = null)
    {
     ...
     * @return Process[]
     */
    public function getProcesses($groups = array()): array
    {
        $processes = array();
     ...
     * @return array result An array containing start statuses
     */
    public function startProcessGroup(string $group, $wait = true): array
    {
     ...
     * @return array result An array containing start statuses
     */
    public function stopProcessGroup($group, $wait = true): array
    {
     ...
     */
    public function sendRemoteCommEvent(string $type, string $data): bool
    {
